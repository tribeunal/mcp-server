 ...
 * token. Every one of the 41 shared tools is therefore executed AS the
 ...
 * the stdio transport uses. This keeps the 41 tools byte-identical across both
...
export class TribeunalMCP extends McpAgent<Env, Record<string, never>, UserProps> {
  ...
  async init(): Promise<void> {
    ...
    // tools/list — advertise the shared 41 tool definitions verbatim.
